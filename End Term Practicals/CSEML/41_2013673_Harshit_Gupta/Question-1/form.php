...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `books` (`bookName`, `authorName`, `isbnNumber`, `publisherName`, `publicationYear`, `noOfPages`, `bookType`) VALUES ('$bName', '$aName', '$isbnNumber', '$pName', '$pYear', '$bType', '$pages')";    
...
<html>
  <body>
        <form method="POST" action="form.php">
            ...
            Author <input type="text" placeholder="Enter Author Name" name="Author"><br><br>
            ISBN <input type="text" placeholder="Enter ISBN Number" name="ISBN"><br><br>
            Publisher <input type="text" placeholder="Enter Publisher Name" name="Publisher"><br><br>
