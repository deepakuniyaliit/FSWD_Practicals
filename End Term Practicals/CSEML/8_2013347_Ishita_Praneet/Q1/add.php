...
$sql="INSERT INTO `BookStore` VALUES ('$bookName','$authorName' , '$isbnNumber','$publisherName' ,'$publicationyear','$booktype','$noofpages')";
...
<html>
    ...
    <body>
        <form method="POST" action="add.php">
            Book Name:<input type="text" name ="bookname" placeholder="Enter Book Name" name="bname"><br><br>
