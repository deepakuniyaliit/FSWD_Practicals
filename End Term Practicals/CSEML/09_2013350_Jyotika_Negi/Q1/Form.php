...
if(isset($_POST['submit'])){
    ...
    $publicationY=$_POST['publicationY'];
    $pages = $_POST['pages'];
    $booktype=$_POST['booktype'];
	$sql =  "INSERT INTO `bookstore` (`bookname`, `author`, `isbn`,`publisher`,`publicationY`, `pages`, `booktype`) VALUES ('$bookname', '$author', '$isbn','$publisher','$publicationY','$pages','$booktype')";
...
<body>
 ...
 isbn Number <input type="text" name="isbn"> <br> <br>
    ...
    <label>publication year</label>
        <select name="publicationY" id="publicationY">
        ...
        <input type="range" min="200" max="400" value="200" name="pages"> <br><br>
