...
{    
     ...
     $sql = "INSERT INTO bookstore (bookName,authorName,isbnNumber,publisherName,bookType,publishYear,volume)
VALUES ('$bookName','$authorName','$isbnNumber', '$publisherName','$booktype', '$pubyear','$volume' )";
