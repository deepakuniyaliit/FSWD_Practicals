<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO Book (`Book ID`, `Book Name`, `Author`, `ISBN`, `Publisher`, `Publication Year`, `Pages`, `Book Type`) VALUES ('$bookname', '$authorname', '$isbn', '$publisher', '$year', '$pages', '$booktype')";
...
<html>
    ...
    <body>
        ...
        <table cellspacing = "10">
            <tr>
                <td>Book Name</td>
                <td><input type="text" style="width: 230px" name="bookName" required></td>
            </tr>
            <tr>
                <td>Author Name</td>
                <td><input type="text" style="width: 230px" name="auhtorName" required></td>
            </tr>
            <tr>
                <td>ISBN Number</td>
                <td><input type="text" style="width: 230px" name="isbnNumber" required></td>
            </tr>
            <tr>
                <td>Publisher Name</td>
                <td><input type="text" style="width: 230px" name="publisherName" required></td>
            </tr>
            <tr>
                <td>Publication Year</td>
                <td>
                    <select style="width: 230px" name="publicationYear" required>
                        <option>2010</option>
                        <option>2011</option>
                        <option>2012</option>
                        <option>2013</option>
            ...
            <tr>
                ...
                <td><input type="Number" style="width: 230px" name="noOfPages" required></td>
            </tr>
            <tr>
                <td>Book Type</td>
                <td id = "radio">
