...
if(isset($_POST['submit']))
{
    ...
    $Isbn=$_POST['ISBN Number'];
    $Publisher=$_POST['Publisher Name'];    
    $Publication=$_POST['Publication Year'];    
    $Pages=$_POST['Number of Pages'];
    $BookType=$_POST['Book Type'];
    $sql="INSERT INTO BookStore (book, author, isbn, publisher,'year','pages','booktype') VALUES ('$bookname', '$authorname', '$Isbn', '$Publisher','$Publication','$Pages','$Booktype')";         
