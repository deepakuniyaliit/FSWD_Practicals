...
<html>
    ...
    <body>
        ...
        <table cellspacing = "10">
            <tr>
                <td>Book Name</td>
                <td><input type="text" style="width: 100px" name="bookName" required></td>
            </tr>
            <tr>
                <td>Author Name</td>
                <td><input type="text" style="width: 100px " name="auhtorName" required></td>
            </tr>
            <tr>
                <td>ISBN Number</td>
                <td><input type="text" style="width: 100px " name="isbnNumber" required></td>
            </tr>
            <tr>
                <td>Publisher Name</td>
                <td><input type="text" style="width: 100px " name="publisherName" required></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="Number" style="width: 100px " name="noOfPages" min="200" max="400" required></td>
            </tr>
            <tr>
                <td>Book Type</td>
                <td id = "radio">
