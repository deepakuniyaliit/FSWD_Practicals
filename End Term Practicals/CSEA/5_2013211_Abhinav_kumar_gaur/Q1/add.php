...
<form method="POST" action="add.php">
    ...
    noofpage <input type="number" name="noOfPages" placeholder="Type book name" mix="400" min="200" required><br>
    booktype:  
     <input type="radio" name="bookType" value="action"> Action
     <input type="radio" name="bookType" value="advanture"> advanture
     ...
     <input type="radio" name="bookType" value="noval"> noval
     <input type="radio" name="bookType" value="detecctive"> detecctive
     <input type="radio" name="bookType" value="mystry"> mystry<br>
