...
Author Name   :<input type="text" name="author" placeholder="enter author" required ><br>
Isbn Number :<input type="text" name="isbn" placeholder="enter isbn number" required ><br>
Publisher Name :<input type="text" name="publisher" placeholder="enter publisher" required ><br>
