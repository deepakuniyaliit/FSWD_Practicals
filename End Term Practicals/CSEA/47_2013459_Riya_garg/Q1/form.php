...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `users` (`bookName`, `authorName`, `isbnNumber`, `publisherName`, `publicationYear`, `noOfPages`, `bookType`) VALUES (`$bookName`, `$authorName`, `$isbnNumber`, `$publisherName`, `$publicationYear`, `$noOfPages`, `$bookType`)";
