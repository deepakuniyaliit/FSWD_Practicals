...
<body>
    <form action="server.php" method="POST">
        ...
        <br>
        Enter ISBN Number: <input type="text" name="isbnno">
        <br>
        Enter Publisher Name: <input type="text" name="pname">
        <br>
        Enter Publication Year: 
            <select id="" name = "pyear">
        ...
        <br>
        Number of pages: <input type="number" min="200" max="400" name="pno">
        <br>
