...
<body>
	...
	<table border="0" align="center" width="60%" cellspacing="12">
		...
		<tr>
			...
			<td><input type="Number" name="isbnNumber" required></td>
		</tr>
		<tr>
			<td><b>publisherName</b></td>
			<td><input type="text" name="" name="publisherName" required>  </td>
		</tr>
		<tr>
			<td><b>publicationYear:</b></td> 
			<td><select name="Year" id="pyear" required>
			...
			<option value="2021">2021</option>
			 ...
			 <tr>     
			<td><b>nOofpages:</b></td> 
			<td><input type="number" min="200" max="400" required></br></td>
		</tr>
		<tr>
