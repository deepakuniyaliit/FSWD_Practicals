...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `book` (`bookName`, `authorName`, `isbnNumber`, `publisherName`, `publicationYear`, `noOfPages`, `bookType`) VALUES ('$bName', '$aName', '$isbnNumber', '$pName', '$pYear', '$pages', '$bType')";    
