...
if(isset($_POST['update'])){
	...
	$sql = "UPDATE `users` SET username='$username', email='$email', contact= '$contact',gender='$gender',city='$city' WHERE id='$id'"; 	
...
<body>
<form method="post" action = "retrieve.php?id=<?php  echo "$id"?>">	
<table id = "frm" align = "center" border = "3" cellspacing = " 20">

	
	<tr><td>USER NAME<td><input type="text" placeholder="Enter Username" name = "username" value = "<?php echo $username?>" required></td></tr>
